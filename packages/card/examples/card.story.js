...
export const basic = () => (
  <div className="bg-gray-300 w-full h-full py-5 px-5 relative">
    <Card
    ...
    <Card
      title={(
        <div className="flex flex-row items-center">
          <span className="flex flex-row items-center text-black text-sm"><Avatar size="sm" circle color="blue" colorContrast={500} mr={2}><p className="text-white">YP</p></Avatar> Yudha Pratama</span>
