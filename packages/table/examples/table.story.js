...
export const tableBox = () => {
  ...
  const rows = [
    {
      photo: (<Image src="https://tailwindcss.com/img/placeholder-amber.svg" alt="image basic" circle={true} size={"xs"} />),
      brand: (
        <>
          <p className="py-0">Apple</p>
          <p className="py-0">mail@apple.com</p>
        </>
      ),
      category: "Technology",
      price: "$200.00",
    },
    {
      ...
      brand: (
        <>
          <p className="py-0">Google</p>
          <p className="py-0">mail@google.com</p>
        </>
      ),
      category: "Technology",
      price: "$150.00",
  ...
  return(
    <>
      <Table.Box columns={columns} rows={rows} columnsColor={"gray"} columnsColorContrast={800} columnsTextColor={"gray"} columnsTextColorContrast={200} rowsColor={"gray"} rowsColorContrast={800} textColor={"white"} rounded={"lg"} />
    </>
  )
}
