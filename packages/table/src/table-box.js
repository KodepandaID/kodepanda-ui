...
const IndeterminateCheckbox = forwardRef(
  ...
  const ReactTable = ({ height, columns, data, setSelected, scroll, columnsColor, columnsColorContrast, columnsTextColor, columnsTextColorContrast, rowsColor, rowsColorContrast, textColor, textColorContrast, emptyState, emptyStateIcon, emptyStateText, emptyStateImage, rounded,
  ...
  const TableBox = ({ shadow, rounded, columns, columnsColor, columnsColorContrast,
    ...
    rows, rowsColor, rowsColorContrast,
    ...
    return(
      <div className={wrapper}>
        ...
        rowsColor={rowsColor} rowsColorContrast={rowsColorContrast}
