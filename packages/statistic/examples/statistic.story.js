...
export const icon = () => <Statistic title="Active Users" value={1000} icon="users" />

export const preffix = () => <Statistic title="Account Balance (IDR)" value={100000} preffix={(<span className="text-bold text-2xl">Rp</span>)} />

export const suffix = () => <Statistic title="Rank" value={1} suffix="/ 10" />

export const textSize = () => <Statistic title="Active Users" value={1000} textSize="3xl" />
