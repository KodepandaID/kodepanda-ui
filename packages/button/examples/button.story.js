...
export const borderStyle = () => (
  <div className="flex flex-row">
    <Button color="white" border borderStyle="dotted" mr={5}>Button</Button>
    <Button color="white" border borderStyle="dashed">Button</Button>
  </div>
)
...
export const group = () => (
  <Button.Group>
    <Button size="md" rounded="md" roundedPosition="left">1</Button>
    <Button size="md" rounded="none">2</Button>
    <Button size="md" rounded="md" roundedPosition="right">3</Button>
  </Button.Group>
)
...
export const dropdown = () => (
  <Button.Dropdown>
    ...
    <Dropdown width={32}>
      ...
      <Divider />
      <Dropdown.List colorHover="red" colorHoverContrast={200} textColorHover="red">
