...
export const ButtonGroup: React.FC<ButtonGroupProps> & {
  ...
  const [ButtonGroupProvider, ButtonGroupContext] = createContext<ButtonGroupProps>(PROVIDER_NAME, {
    ...
    textColorHover: tb?.textColorHover !== undefined ? tb.textColorHover : props.textColorHover,
    textColorHoverContrast: tb?.textColorHoverContrast !== undefined ? tb.textColorHoverContrast : props.textColorHoverContrast,
    ...
    darkTextColorHover: tb?.darkTextColorHover !== undefined ? tb.darkTextColorHover : props.darkTextColorHover,
    darkTextColorHoverContrast: tb?.darkTextColorHoverContrast !== undefined ? tb.darkTextColorHoverContrast : props.darkTextColorHoverContrast,
