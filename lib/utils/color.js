...
const color = (type, color, contrast) => {
  if (type === "bg") {
    return `bg-${color}${color === "white" || color === "black" ? "":`-${contrast}`}`
  } else if (type === "border") {
    return `border-${color}${color === "white" && color === "black" ? "":`-${contrast === undefined ? "600": contrast}`}`
  } else if (type === "text") {
    return `text-${color}${color === "white" || color === "black" ? "":`-${contrast}`}`
  }
}


export { color as Color }
export { palletes as Palletes }
export { palleteStatic as PalleteStatic }