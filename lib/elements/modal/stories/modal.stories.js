...
export const basic = () => {
  ...
  return(
    <div className="w-full">
      ...
      footer={(
        <div className="flex flex-row float-right pb-3">
          <Button size="sm" color="white" mr={2} onClick={() => setOpen(false)}>No, I'm not</Button>
          <Button size="sm" color="red">Yes, Delete it</Button>
        </div>
      )}
      visible={open}
