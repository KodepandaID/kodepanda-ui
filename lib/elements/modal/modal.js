...
const Modal = ({ bgImage, bgImageOverlay, size, title, subTitle, content, cover, coverPosition, footer,
  ...
  useEffect(() => {
    setShow(visible)
    console.log((title === undefined && cover === undefined) ? "top-2 right-2" : "-top-7 right-0")
