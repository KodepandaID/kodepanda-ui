...
const Accordion = ({ children, className, simple, border, shadow, defaultActiveIndex,
  ...
  const baseClasses = cx(
    ...
    (borderColor !== undefined && !simple) && `${Color("border", borderColor, borderColorContrast === undefined ? 500 : borderColorContrast)}`,
