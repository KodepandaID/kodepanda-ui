...
const Box = ({ children, className, bgColor, border, borderSize, borderColor, borderContrast, textColor, textAlign, contrast, rounded, roundedPosition, shadow,
  mx, my, mb, ml, mr, mt,
  px, py, pb, pl, pr, pt }) => {
  const baseClasses = cx(
    ...
    borderColor !== undefined && `${Color("border", borderColor, borderContrast === undefined ? 500 : borderContrast)}`,
