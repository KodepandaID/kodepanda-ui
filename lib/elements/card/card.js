...
const Card = ({ bgImage, bgImageOverlay, size, title, description, cover, coverPadding, coverPosition, footer,
  ...
  const coverImageClasses = cx(
    "h-full",
    (coverPosition === "top" && coverPadding === undefined && rounded) && `rounded-t-${roundedSize}`,
    (coverPosition === "left" && coverPadding === undefined && rounded) && `rounded-l-${roundedSize}`,
    (coverPosition === "right" && coverPadding === undefined && rounded) && `rounded-r-${roundedSize}`,
    (coverPadding !== undefined && rounded) && RoundedSize[roundedSize],
  )
