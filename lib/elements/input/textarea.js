...
const TextArea = ({ className, defaultValue, width, fluid, disabled, placeholder, size, rounded,
  ...
  return(
    <textarea className={baseClasses} defaultValue={defaultValue} placeholder={placeholder} disabled={disabled} onChange={onChange} />
  )
}
