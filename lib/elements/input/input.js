...
const Input = ({ id, name, className, width, defaultValue, fluid, disabled, placeholder, size, rounded, type, onChange,
    ...
    <>
      <div className={baseClasses}>
        ...
        {(labelIcon !== undefined && labelPosition === "left") && (
          <div className={labelClasses}><Icon icon={labelIcon} color={["gray", "white"].includes(labelColor) ? "gray" : "white"} contrast={500} /></div>
        )}
        {((button !== undefined || buttonIcon !== undefined) && buttonPosition === "left") && (
          <Button labeled={(buttonIcon !== undefined && button !== undefined) ? true:false} labeledIcon={buttonIcon} color={buttonColor} contrast={buttonColorContrast} rounded={rounded} roundedPosition="left">{button === undefined ? <Icon icon={buttonIcon} /> : button}</Button>
        )}
        <input id={id} name={name} className={inputClasses} placeholder={placeholder} disabled={disabled} type={type} defaultValue={defaultValue} onChange={onChange} />
        ...
        {((button !== undefined || buttonIcon !== undefined) && buttonPosition === "right") && (
          <Button labeled={(buttonIcon !== undefined && button !== undefined) ? true:false} labeledIcon={buttonIcon} color={buttonColor} contrast={buttonColorContrast} rounded={rounded} roundedPosition="right">{button === undefined ? <Icon icon={buttonIcon} /> : button}</Button>
        )}
      </div>
...
Input.propTypes = {
  ...
  buttonIcon: PropTypes.oneOf(Object.keys(Icon.Solid)),
