...
const Input = ({ className, width, defaultValue, fluid, disabled, placeholder, size, rounded, type, onChange,
  ...
  return(
    <>
      <div className={baseClasses}>
        ...
        <input className={inputClasses} placeholder={placeholder} disabled={disabled} type={type} defaultValue={defaultValue} onChange={onChange} />
