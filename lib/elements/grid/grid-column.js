...
const Column = ({ children, className, width,
  ...
  const baseClasses = cx(
    ...
    screenMD !== undefined && `sm:${typeof screenMD === "number" ? widthSizes[screenMD]:`w-${screenMD}`}`,
    screenLG !== undefined && `sm:${typeof screenLG === "number" ? widthSizes[screenLG]:`w-${screenLG}`}`,
    screenXL !== undefined && `sm:${typeof screenXL === "number" ? widthSizes[screenXL]:`w-${screenXL}`}`,
    screen2XL !== undefined && `sm:${typeof screen2XL === "number" ? widthSizes[screen2XL]:`w-${screen2XL}`}`,
  )
