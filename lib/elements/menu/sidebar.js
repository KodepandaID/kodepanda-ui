                ...
                {el.props.children.length !== undefined && (
                  el.props.children.map((elc, j) => {
                    const listClasses =  cx(
                      elc.type.name !== "Collapse" && "flex items-center",
                      ...
                      elc.type.name !== "Collapse" && Padding(px, py, pb, pl, pr, pt)
                    )

                    if (elc.type.name === "Item") {
                      return(
                    ...
                    } else if (elc.type.name === "Collapse") {
                      return(<Collapse key={j} className={listClasses}
