...
const Menu = ({ className, children, height, shadow,
  color, colorContrast, responsiveColor, responsiveColorContrast, textColor, textColorContrast,
    ...
    <div className="relative">
      <div className={wrapperClasses}>
        <div className="w-full flex flex-nowrap items-center">
          {children}
          {responsive !== "none" && (
            <div className={responsiveIconClasses} onClick={() => setShowMenuResponsive(!showMenuResponsive)}><Icon icon={showMenuResponsive ? "x" : "menu-alt-3"} color={textColor} colorContrast={textColorContrast} height={responsiveIconSize} /></div>
          )}
        </div>
      </div>
