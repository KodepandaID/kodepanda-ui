...
const Item = ({ children, active, rounded, disabled, href, target, onClick,
  ...
  const wrapperClasses = cx(
    ...
    (!disabled && borderHoverColor !== undefined) && `border-b${BorderSizeNum[borderHoverSize]} ${Color("border", borderHoverColor, borderHoverColorContrast)}`,
