          ...
          {files.map((file, i) => {
            ...
            return(
              <div key={i} className={listClasses(progressSuccess[i])}>
                <Grid>
                  <Grid.Row>
                    ...
                    <Grid.Column width="1/5">
                      {(progress && progressSuccess[i] === "completed") && (
                      ...
                      {(progress && progressSuccess[i] === "failed") && (
                ...
                {progress && (
                  <Progress width="full" percentage={progressSuccess[i] === "failed" ? 100 : progressPercent[i]} color={progressSuccess[i] === "failed" ? "red" : progressColor} colorContrast={progressColorContrast} bgColor={progressBgColor} bgColorContrast={progressBgColorContrast} />
                )}
