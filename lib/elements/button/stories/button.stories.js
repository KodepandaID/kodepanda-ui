...
export default {
  ...
  argTypes: {
    color: {
      ...
      default: "blue",
      options: ["white", "black", "gray", "red", "green", "blue", "teal", "pink",
      "purple", "cyan", "indigo", "rose", "fuchsia", "blue-gray", "emerald",
...
export const dropdown = () => (
  <>
    <Button.Dropdown>
      ...
      <Dropdown>
        <Dropdown.List>
          <Icon icon="pencil-alt" color="blue" contrast={500} mr={2} /> Edit
        </Dropdown.List>
        <Dropdown.List>
          <Icon icon="duplicate" color="blue" contrast={500} mr={2} /> Duplicate
        </Dropdown.List>
        <Divider />
        <Dropdown.List bgColor={"red"} color={"red"}>
          <Icon icon="trash" color="red" contrast={500} mr={2} /> Delete
        </Dropdown.List>
      </Dropdown>
    </Button.Dropdown>
  </>
