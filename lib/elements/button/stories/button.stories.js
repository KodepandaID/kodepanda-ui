...
export const labeledIcon = () => (
  <div className="h-14 flex flex-wrap content-center">
    <div>
      <Button labeled labeledIcon="check" labeledPosition="left" mr={5}>Button Icon</Button>
    </div>
    <div>
      <Button labeled labeledIcon="check" labeledPosition="right">Button Icon</Button>
    </div>
  </div>
)
