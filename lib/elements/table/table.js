...
const ReactTable = ({ height, columns, data, setSelected, columnsColor, columnsColorContrast, stripe, line, scroll, rowsColor, rowsColorContrast, rowsStripeColor, rowsStripeColorContrast, textColor, textColorContrast, border, borderColor, borderColorContrast, checkbox }) => {
  const {
    getTableProps,
    getTableBodyProps,
    headerGroups,
